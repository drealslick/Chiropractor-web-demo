...
export const defaultLocations: ClinicLocation[] = [
  {
    id: 'loc-marylebone',
    name: 'Marylebone Central (Flagship)',
    tagline: 'Harley Street Medical Corridor',
    isPrimary: true,
    address: '44 Wicklow St, Marylebone',
    city: 'London',
    ...
    email: 'marylebone@vancehealth.co.uk',
    hoursWeekday: 'Mon–Fri: 8:00 AM – 7:00 PM',
    hoursSaturday: 'Sat: 9:00 AM – 2:00 PM',
    parkingNote: 'Dedicated patient bays in rear courtyard. Metered street parking on Wicklow St.',
    transitNote: '2 min walk from King’s Cross St. Pancras & Russell Square Station.',
    assignedPractitionerIds: ['team-1', 'team-2'],
    active: true,
  },
  {
    id: 'loc-canary-wharf',
    name: 'Canary Wharf Financial Suite',
    tagline: 'Executive Spine & Posture Clinic',
    isPrimary: false,
    address: '25 Bank Street, 14th Floor',
    city: 'London',
    state: 'Greater London',
    cityState: 'London, UK',
    zip: 'E14 5JP',
    phone: '+44 20 7946 0883',
    phoneRaw: '442079460883',
    email: 'canarywharf@vancehealth.co.uk',
    hoursWeekday: 'Mon–Thu: 7:30 AM – 6:30 PM, Fri: 8:00 AM – 4:00 PM',
    hoursSaturday: 'Sat: Closed',
    parkingNote: 'Underground valet parking at Cabot Square with validated ticket.',
    transitNote: 'Direct Elizabeth Line & Jubilee Line access via Jubilee Place Mall.',
    assignedPractitionerIds: ['team-1', 'team-3'],
    active: true,
  },
  {
    id: 'loc-chelsea',
    name: 'Chelsea & Kensington Studio',
    tagline: 'Sports Rehabilitation & Athletic Recovery',
    isPrimary: false,
    address: '118 Kings Road, Suite 3B',
    city: 'London',
    state: 'Greater London',
    cityState: 'London, UK',
    zip: 'SW3 4TR',
    phone: '+44 20 7946 0441',
    phoneRaw: '442079460441',
    email: 'chelsea@vancehealth.co.uk',
    hoursWeekday: 'Mon–Fri: 8:30 AM – 6:30 PM',
    hoursSaturday: 'Sat: 9:00 AM – 1:00 PM',
    parkingNote: 'Sloane Square NCP parking 3 minutes walking distance.',
    transitNote: '5 min walk from Sloane Square Underground Station.',
    assignedPractitionerIds: ['team-2', 'team-3'],
    active: true,
  },
];
...
export const defaultClinic: ClinicInfo = {
  ...
  activeLocationId: 'loc-marylebone',
