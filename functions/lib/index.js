...
exports.cleanupStaleDemoSessions = exports.sendTransactionalEmail = exports.stripeWebhook = exports.createPaymentIntent = exports.setClinicUserRole = exports.ensureUserClaims = exports.claimInitialClinicAdmin = exports.onUserCreated = void 0;
...
exports.createPaymentIntent = functions.https.onCall(async (data, context) => {
    const { clinicId, appointmentId, amount, currency = 'gbp', paymentChoice = 'full', patientEmail, patientName, serviceTitle, } = data;
    if (!clinicId || typeof clinicId !== 'string') {
